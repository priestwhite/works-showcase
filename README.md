...
| # | 專案名稱 | 核心能力 | 說明 |
|---|----------|----------|------|
| 001 | [客服營運監控 Dashboard](#003-客服營運監控-dashboard) | 數據可視化 / 後端整合 | 自動彙整多來源數據，即時呈現客服 KPI |
| 002 | [LINE 客服訊息資料化工具](#004-line-客服訊息資料化工具) | 訊息接收 / 同步保存 / 回溯監控 | 接收、同步與保存 LINE 官方帳號訊息，支援後續客服回溯與營運監控 |
| 003 | [醫療表單電子化與人工覆核工具](#005-醫療表單電子化與人工覆核工具) | OCR 流程電子化 / 人工覆核 / 規則標記 | 將固定格式表單轉為可覆核的結構化資料，輔助後續人工追蹤與資料整理 |

> 📌 更多專案持續更新中

---

## 001 客服營運監控 Dashboard
